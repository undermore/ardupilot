...
bool Copter::ModeFlowHold::init(bool ignore_checks)
{
    ...
    copter.pos_control->set_speed_z(-get_pilot_speed_dn(), copter.g.my_pilot_speed_up);
...
void Copter::ModeFlowHold::run()
{
    ...
    target_climb_rate = constrain_float(target_climb_rate, -get_pilot_speed_dn(), copter.g.my_pilot_speed_up);
